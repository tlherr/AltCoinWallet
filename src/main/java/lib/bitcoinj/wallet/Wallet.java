...
import lib.bitcoinj.core.listeners.*;
import lib.bitcoinj.core.Address;
import lib.bitcoinj.core.AbstractBlockChain;
import lib.bitcoinj.core.BlockChain;
import lib.bitcoinj.core.BloomFilter;
import lib.bitcoinj.core.Coin;
import lib.bitcoinj.core.Context;
import lib.bitcoinj.core.ECKey;
import lib.bitcoinj.core.FilteredBlock;
import lib.bitcoinj.core.InsufficientMoneyException;
import lib.bitcoinj.core.LegacyAddress;
import lib.bitcoinj.core.Message;
import lib.bitcoinj.core.NetworkParameters;
import lib.bitcoinj.core.Peer;
import lib.bitcoinj.core.PeerFilterProvider;
import lib.bitcoinj.core.PeerGroup;
import lib.bitcoinj.core.Sha256Hash;
import lib.bitcoinj.core.StoredBlock;
import lib.bitcoinj.core.Transaction;
import lib.bitcoinj.core.TransactionBag;
import lib.bitcoinj.core.TransactionBroadcast;
import lib.bitcoinj.core.TransactionBroadcaster;
import lib.bitcoinj.core.TransactionConfidence;
import lib.bitcoinj.core.TransactionInput;
import lib.bitcoinj.core.TransactionOutPoint;
import lib.bitcoinj.core.TransactionOutput;
import lib.bitcoinj.core.UTXO;
import lib.bitcoinj.core.UTXOProvider;
import lib.bitcoinj.core.UTXOProviderException;
import lib.bitcoinj.core.Utils;
import lib.bitcoinj.core.VerificationException;
import lib.bitcoinj.core.TransactionConfidence.*;
import lib.bitcoinj.crypto.*;
import lib.bitcoinj.script.*;
import lib.bitcoinj.signers.*;
import lib.bitcoinj.utils.*;
import lib.bitcoinj.wallet.Protos.Wallet.*;
import lib.bitcoinj.wallet.WalletTransaction.*;
import lib.bitcoinj.wallet.listeners.KeyChainEventListener;
import lib.bitcoinj.wallet.listeners.ScriptsChangeEventListener;
import lib.bitcoinj.wallet.listeners.WalletChangeEventListener;
import lib.bitcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import lib.bitcoinj.wallet.listeners.WalletCoinsSentEventListener;
import lib.bitcoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
...
public class Wallet extends BaseTaggableObject
     ...
     * @throws lib.bitcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
     ...
     */
    public void setTransactionBroadcaster(@Nullable lib.bitcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws lib.bitcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
