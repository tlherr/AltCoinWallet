...
public class KeyChainGroup implements KeyBag {
     ...
     * @see lib.bitcoinj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws lib.bitcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws lib.bitcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
