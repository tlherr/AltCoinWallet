...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws lib.bitcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws lib.bitcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
