...
import lib.bitcoinj.crypto.KeyCrypter;
import lib.bitcoinj.crypto.KeyCrypterScrypt;
import lib.bitcoinj.script.Script;
import lib.bitcoinj.script.ScriptException;
import lib.bitcoinj.signers.LocalTransactionSigner;
import lib.bitcoinj.signers.TransactionSigner;
import lib.bitcoinj.utils.ExchangeRate;
import lib.bitcoinj.utils.Fiat;
import lib.bitcoinj.wallet.Protos.Wallet.EncryptionType;
...
public class WalletProtobufSerializer {
    ...
    private WalletTransaction connectTransactionOutputs(final NetworkParameters params,
                                                        final lib.bitcoinj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
