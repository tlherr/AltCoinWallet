...
import lib.bitcoinj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws lib.bitcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws lib.bitcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
