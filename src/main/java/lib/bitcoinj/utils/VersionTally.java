 ...
 *
 * @see lib.bitcoinj.core.NetworkParameters#getMajorityWindow()
 * @see lib.bitcoinj.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see lib.bitcoinj.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */
