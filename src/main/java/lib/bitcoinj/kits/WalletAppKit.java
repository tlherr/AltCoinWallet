...
import lib.bitcoinj.protocols.channels.*;
import lib.bitcoinj.store.*;
import lib.bitcoinj.wallet.*;
import org.slf4j.*;
...
public class WalletAppKit extends AbstractIdleService {
    ...
    protected BitcoinJSONRPCClient serverConnection;
