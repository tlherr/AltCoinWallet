...
package lib.bitcoinj.protocols.channels;
...
import lib.bitcoinj.core.*;
import lib.bitcoinj.crypto.TransactionSignature;
import lib.bitcoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
 ...
 *
 * <p>This class implements the lib state machine for the client side of the protocol. The server side is implemented
